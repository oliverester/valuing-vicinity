...
class WSIFromFolder():
    ...
    def _draw_patches(self) -> List[PatchFromFile]:
        if self.wsi_dataset.draw_patches_per_class is not None:
            draw_idxs = []
            print(f"Drawing {self.wsi_dataset.draw_patches_per_class} random patches per patch "
            ...
            for tmp_lbl in set(patch_labels):
                ...
                if self.wsi_dataset.draw_patches_per_class >= len(tmp_lbl_idxs):
                    print(f"Warning: draw_patches_per_class ({self.wsi_dataset.draw_patches_per_class})"
